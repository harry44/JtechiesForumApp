...
class CommentsController {
    ...
    def showAll(){
        render template: 'comments',model:[commentsList:Comments.findAllByPost(Post.get(params.id))]
    }
    ...
    def saveComment(){
        ...
        params.post=Post.get(params.post)
        commentsInstance.properties=params
        commentsInstance.save flush:true
        render(template: 'liveComment',model: [commentsInstance:commentsInstance])
    }
