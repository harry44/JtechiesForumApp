...
<div id="list-category" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="categoryName"
                              title="${message(code: 'category.categoryName.label', default: 'Category Name')}"/>
        ...
        <g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${categoryInstance.id}">${fieldValue(bean: categoryInstance, field: "categoryName")}</g:link></td>

                <td><g:formatDate date="${categoryInstance.dateCreated}"/></td>

                <td><g:formatDate date="${categoryInstance.lastUpdated}"/></td>
                <td><img src="${createLink(controller: 'category' ,action: 'showLogo' ,id:categoryInstance?.id)}"></td>
